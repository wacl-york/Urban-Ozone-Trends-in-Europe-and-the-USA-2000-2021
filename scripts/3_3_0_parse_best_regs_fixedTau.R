...
dirOut = data_path("piecewise","stats", "fixedTau")
...
for(i in 1:length(statsDat)){
  ...
  fileName = file.path(subDir,paste0(type,"_piecewise_stats_fixedTau_",stn,"_", nm, ".csv"))
...
dirOut = data_path("piecewise", "data", "fixedTau")
...
for(i in 1:length(datDat)){
  ...
  fileName = file.path(subDir,paste0(type,"_piecewise_data_fixedTau_",stn,"_", nm, ".csv"))
