...
\begin{abstract}
Trends in urban MDA8O\textsubscript{3}, alongside annual O$_3$ episodic and exposure metrics, across Europe and the United States of America were explored between 2000-2021. Using surface monitoring site data from the TOAR-II and European Environment Agency databases, piecewise quantile regression (PQR) analysis was performed on 228 MDA8O\textsubscript{3} time series (144 European, 84 USA). The PQR analysis permitted 2 break points over the 23 year period to balance the intent to describe changes over a large time period, while still capturing the abrupt changes that can occur in urban atmospheres. We found that there were many sites across Europe with high certainty increasing trends in the 5\textsuperscript{th} and 50\textsuperscript{th} quantiles, whereas the majority of high certainty trends in the 95\textsuperscript{th} quantile were found to be decreasing. A similar pattern was observed across the USA, with 5\textsuperscript{th} quantile trends increasing and 95\textsuperscript{th} quantile trends decreasing. Hierarchical clustering with dynamic time warping allowed for the grouping of similarly structured timeseries. Clustering was typically regional across Europe and the USA, and increasing trends were identified across Southern and the Central alpine regions of Europe, and in California and the Intermountain West of the USA. Recent high certainty increasing trends in MDA8O$_3$ in the Intermountain West may be related to warmer summers and increased wildfire events in the region, highlighting the need to monitor changing trends in MDA8O$_3$ with climate change, to assess human exposure risk to elevated levels of O$_3$
\end{abstract}
...
\begin{itemize}
    ...
    \item SOMO35 - Subtract 35 ppb from the MDA8 value and sum all postive values (ppbv x days)
...
% Trends in MDA8 across quantiles
...
% Spatio-temporal distribution of O$_3$ metrics, relevant to health and exposure
...
\codedataavailability{All data for this study can be downloaded from the relevant databases , this study used the r-packages \emph{toarR} \citep{drysdale_2024_14537446} and \emph{saqgetr} \citep{saqgetr}. Code for performing the download as well as the analysis can be found at 10.5281/zenodo.14538198 \citep{drysdale_2024_14538198}} %% use this section when having data sets and software code available
