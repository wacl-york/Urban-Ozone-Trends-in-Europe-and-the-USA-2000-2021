...
To begin with, the $\tau$ = 0.5 trends of O3 and NO2 were examined and are presented on maps in figures \ref{fig:arrow_eu} and \ref{fig:arrow_us}.

\begin{figure*}[p]
\includegraphics[width=14cm]{figures/f3_eu_arrows.pdf}
\caption{}
\label{fig:arrow_eu}
\end{figure*}
...
\begin{figure*}[p]
\includegraphics[width=14cm]{figures/f4_usa_arrows.pdf}
\caption{}
\label{fig:arrow_us}
\end{figure*}
...
\begin{figure}[9]
\includegraphics[width=14cm]{plots/o3_density_ridges_by_tau_continent_2000_2019.png}
\caption{O3 slope density for Europe (left) and the USA (right) since 2000 (top) and 2019 (bottom) for $\tau$ = 0.05, 0.1, 0.25, 0.5, 0.75, 0.9 and 0.95. NO2 slope density for Europe (left) and the USA (right) since 2000 (top) and 2019 (bottom) for $\tau$ = 0.05, 0.10, 0.25, 0.50, 0.75, 0.90 and 0.95.}
\label{fig:ridgeplot}
\end{figure}
