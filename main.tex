...
\caption{Time series of annual average MDA8O\textsubscript{3}, O3\textsubscript{3} and NO\textsubscript{2} for urban sites in Europe and the USA, for the time series types detailed in (table \ref{tab:ts_types})}
\label{fig:conc_plot}
\end{figure*}
