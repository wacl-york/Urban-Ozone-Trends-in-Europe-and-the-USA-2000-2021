...
\begin{figure}[p]
\includegraphics[width=14cm]{figures/f6_ridgelines.pdf}
\caption{Slope density for Europe (left) and the USA (right) since 2000 (top) and 2019 (bottom) for $\tau$ = 0.05, 0.1, 0.25, 0.5, 0.75, 0.9 and 0.95. NO2 slope density for Europe (left) and the USA (right) since 2000 (top) and 2019 (bottom) for $\tau$ = 0.05, 0.10, 0.25, 0.50, 0.75, 0.90 and 0.95.}
\label{fig:ridgeplot}
\end{figure}
