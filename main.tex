...
\subsection{Hierarchical Clustering of MDA8O$_3$ time series} \label{sect:cluster_stuff}
...
\begin{figure}[p]
\includegraphics[width=12cm]{figures/paper_figures/slope_sig_counts.pdf}
\caption{Number of sites across slope significance and slope magnitude categories. }
...
\begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textwidth]{figures/paper_figures/cluster_maps/eu_clusters.pdf}
    \caption{}
\end{sidewaysfigure}
\clearpage
...
\begin{sidewaysfigure}[p]
    \centering
    \includegraphics[width=\textwidth]{figures/paper_figures/cluster_maps/us_clusters.pdf}
    \caption{}
\end{sidewaysfigure}
\clearpage
...
\begin{figure}[p]
\centering
\includegraphics[height=0.9\textheight]{figures/paper_figures/mda8_6mmda1/mda8_cluster_mda8_6mmda1.pdf}
\caption{}
...
\begin{figure}[p]
\centering
\includegraphics[height=0.9\textheight]{figures/paper_figures/mda8_6mmda1/mda8_warm_cluster_mda8_6mmda1.pdf}
\caption{}
...
\begin{figure}[p]
\centering
\includegraphics[height=0.9\textheight]{figures/paper_figures/mda8_6mmda1/mda8_cold_cluster_mda8_6mmda1.pdf}
\caption{}
