...
qr_piece = tbl(con, "trend_flip_mda8") |>
...
pdf(here::here('figures_mda8','f9_eu_mag_map_mda8.pdf'), width = 8.3, height = 11.7)
print(g1)
dev.off()
...
pdf(here::here('figures_mda8','f10_us_mag_map_mda8.pdf'), width = 11.7, height = 8.3)
print(g2)
dev.off()
