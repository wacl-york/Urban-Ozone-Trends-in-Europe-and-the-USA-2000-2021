...
pdf(here::here('figures_mda8','f6_ridgelines_mda8_anom.pdf'),width = 11.7, height = 8.3)
print(g1)
dev.off()
...
pdf(here::here('figures_mda8','f7_cusum_mda8_anom.pdf'), width = 7.5, height = 7.5)
print(g2)
dev.off()
...
pdf(here::here('figures_mda8','f8_slopes_mda8_anom.pdf'), width = 7.5, height = 7.5)
print(g3)
dev.off()
