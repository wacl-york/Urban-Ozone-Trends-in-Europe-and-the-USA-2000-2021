...
pdf(here::here('figures_mda8','f3_eu_arrows_mda8.pdf'), width = 8.3, height = 11.7)
print(geu)
dev.off()
...
pdf(here::here('figures_mda8','f4_usa_arrows_mda8.pdf'),width = 8.3, height = 11.7)
print(gus)
dev.off()
...
tableDat |>
  ...
  latex_tweaks(
    ...
    label = "table:europe_slope_segs_mda8"
  ) |>
  writeLines(here::here('tables_mda8','t2_europe_segs_11_14_mda8.txt'))
...
tableDat |>
  ...
  writeLines(here::here('tables_mda8','t3_usa_segs_11_14_mda8.txt'))
...
slopeRanges |>
  ...
  latex_tweaks(caption = "5 th, 50 th and 95 th percentiles of the $\\tau$ = 0.5 slopes in Europe and the USA.",
               ...
               sideways = F,
               adjustbox = F) |>
  writeLines(here::here('tables_mda8','t1_slope_ranges_mda8.txt'))
